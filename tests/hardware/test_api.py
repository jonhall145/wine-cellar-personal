...
class TestPositionChangeAPI:
    ...
    def test_report_position_change(self, client, hardware_device_factory, storage_factory, wine_factory):
    ...
    def test_report_high_confidence_auto_applies(self, client, hardware_device_factory, storage_factory, wine_factory):
    ...
    def test_get_pending_reviews(self, client, hardware_device_factory, position_change_review_factory):
        """Test getting pending reviews."""
        device = hardware_device_factory()
        # Create reviews for this user
        review1 = position_change_review_factory(user=device.user, status=ReviewStatus.PENDING)
        review2 = position_change_review_factory(user=device.user, status=ReviewStatus.PENDING)
...
class TestReviewApproval:
    ...
    def test_approve_review_with_correction(self, client, user, position_change_review_factory):
    ...
    def test_cannot_approve_other_user_review(self, client, user, position_change_review_factory):
...
class TestSyncOperations:
    ...
    def test_sync_operations(self, client, hardware_device_factory, storage_factory, wine_factory):
...
class TestRackPositions:
    ...
    def test_get_rack_positions(self, client, hardware_device_factory, storage_factory, storage_item_factory, wine_factory):
    ...
    def test_add_wine_to_position(self, client, hardware_device_factory, storage_factory, wine_factory):
    ...
    def test_remove_wine_from_position(self, client, hardware_device_factory, storage_factory, storage_item_factory, wine_factory):
