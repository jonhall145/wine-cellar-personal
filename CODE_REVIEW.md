...
| 7 | Extract shared wine/whisky abstract base | 🔄 Phase 4 | Phase 1: foundation (mixins, JS merge, storage URLs). Phase 2: 13 base views + 2 AJAX helpers to core. Phase 3: shared filters, forms, Create/Update views to core (~620 lines saved). Phase 4: templates, remaining views |
