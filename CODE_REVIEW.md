...
| 7 | Extract shared wine/whisky abstract base | 🔄 Phase 3 | Phase 1: foundation (mixins, JS merge, storage URLs). Phase 2: 8 more base views + 2 AJAX helpers extracted to core. Phase 3: forms, filters, templates, Create/Update views |
