...
api_urlpatterns = [
    ...
    path("reviews/<int:review_id>/approve/", views.approve_review, name="approve-review"),
    ...
    # Wine endpoints
    path("wines/barcode/<str:barcode>/", views.get_wine_by_barcode, name="wine-by-barcode"),
    ...
    # Storage endpoints
    path("storage/racks/<int:rack_id>/positions/", views.get_rack_positions, name="rack-positions"),
    path("storage/racks/<int:rack_id>/positions/<int:row>/<int:col>/", views.get_position, name="position-detail"),
